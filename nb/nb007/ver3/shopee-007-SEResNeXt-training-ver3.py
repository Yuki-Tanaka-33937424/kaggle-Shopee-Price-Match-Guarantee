...
def train_loop(folds, fold):
    ...
    # model & optimizer
    # ====================================================
    model = CustomSEResNeXt(n_classes=CFG.target_size, model_name=CFG.model_name, pretrained=False).to(device)
    model_path = f'../ver2/seresnext50_32x4d_fold{fold}_best.pth'
