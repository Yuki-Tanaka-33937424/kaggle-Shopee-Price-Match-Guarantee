...
def train_loop(folds, fold):
    ...
    # model & optimizer
    # ====================================================
    model = CustomSEResNet152D(n_classes=CFG.target_size, model_name=CFG.model_name, pretrained=False).to(device)
    model_path = f'../ver3/seresnet152d_fold{fold}_best.pth'
